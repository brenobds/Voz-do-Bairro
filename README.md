...
* **StyleSheet Nativo:** Estilização sob medida feita do zero para rodar liso na Web, garantindo bordas arredondadas, sombras bonitas e uma largura máxima controlada (`maxWidth: 480px`) para o layout não ficar esticado e bizarro no computador.
...
Web First & StyleSheet: Mudamos o foco do Tailwind/NativeWind para o StyleSheet nativo do React Native. Essa decisão corrigiu os bugs de CSS que davam tilt no navegador, deixando o menu inferior e os formulários limpos, modernos e funcionais.
